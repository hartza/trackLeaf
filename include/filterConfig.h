...
#define FILTERCONFIG_H
  ...
  const double SIGMA_SYSTEM_NOISE_X     = 2.0;
  const double SIGMA_SYSTEM_NOISE_Y     = 2.0;
  const double SIGMA_SYSTEM_NOISE_Z     = 2.0;
  const double SIGMA_SYSTEM_NOISE_ROLL  = 2.0;
  const double SIGMA_SYSTEM_NOISE_PITCH = 2.0;
  const double SIGMA_SYSTEM_NOISE_YAW   = 2.0;
  ...
  const double SIGMA_MEAS_NOISE_X     = 0.01;
  const double SIGMA_MEAS_NOISE_Y     = 0.01;
  const double SIGMA_MEAS_NOISE_Z     = 0.01;
  const double SIGMA_MEAS_NOISE_ROLL  = 0.01;
  const double SIGMA_MEAS_NOISE_PITCH = 0.01;
  const double SIGMA_MEAS_NOISE_YAW   = 0.01;
