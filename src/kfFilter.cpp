...
staticMeasNoiseMu (MEAS_SIZE), staticMeasNoiseCov (MEAS_SIZE), priorMu (STATE_SIZE), priorCov (STATE_SIZE)
{
...
void
PoseEstimationFilter::updateFromMeasurement (const BFL::ColumnVector & measurement,
...
void
PoseEstimationFilter::updateFromMotion (const BFL::ColumnVector & input,
...
void
PoseEstimationFilter::getPosteriorMean (BFL::ColumnVector & mean)
{
...
void
PoseEstimationFilter::getPosteriorCovariance (BFL::SymmetricMatrix & covariance)
{
  BFL::Pdf < BFL::ColumnVector > *posterior = ekfFilter->PostGet ();
...
void
PoseEstimationFilter::initStaticSysModel ()
{
...
void
PoseEstimationFilter::initStaticMeasModel ()
{
...
void
PoseEstimationFilter::initPriorModel ()
{
